...
CREATE TABLE competencia (
    ...
    UNIQUE KEY uk_competencia_area (area_id, descripcion(255))
) ENGINE=InnoDB;
...
CREATE TABLE capacidad (
    ...
    UNIQUE KEY uk_capacidad_competencia (competencia_id, descripcion(255))
) ENGINE=InnoDB;
...
CREATE TABLE desempeno (
    ...
    FOREIGN KEY (competencia_id) REFERENCES competencia(id) ON DELETE CASCADE,
    UNIQUE KEY uk_desempeno_grado_competencia (grado_id, competencia_id, descripcion(255))
) ENGINE=InnoDB;
...
INSERT INTO docente (id, nombre, email, institucion_id, created_at) VALUES
    (1, 'Ana Torres Quispe', 'ana.torres@demo.edu.pe', 1, '2026-04-01 08:00:00'),
    (2, 'Luis Rojas Paredes', 'luis.rojas@demo.edu.pe', 2, '2026-04-01 08:30:00');
